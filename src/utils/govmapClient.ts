...
// שבועיים וחצי — תואם למטמון שבשרת. שאיבה עולה קרדיט ומחירים זזים לאט,
// ולכן עדיף נתון שמור בחינם מאשר חיוב חוזר על אותה עיר.
const LOCAL_CACHE_TTL_MS = 420 * 60 * 60 * 1000; // שבועיים וחצי (420 שעות)
